...
- Public logs are written in English by default.
- Chinese or raw working notes are archived locally and are not committed.
- When checking for new AI + CAD projects or important updates, add or update a dated English log here.
- Prefer filenames such as `YYYY-MM-DD-topic.md`.
- Each log should include the date, scan scope, key findings, recommended actions, and source links.
